...
\begin{itemize}
    \item \textbf{SA-NAS framework:} We propose a Structure-Aware Neural Architecture Search (SA-NAS) framework that optimizes expert architectures with respect to the clustering structure of the data.
    \item \textbf{Theoretical understanding:} We provide a theoretical foundation for our method, demonstrating how the data’s clustering structure influences the final architectures identified by the search algorithm.
\end{itemize}