...
Пример:
    python prepare_cifar100_semantic.py --output-dir ./cifar100_data_semantic \\
        --fraction 0.7 --n-clusters 30 --seed 322 --device cuda:0
"""
...
def prepare_cifar100_semantic(
    ...
    # --- 4. Train/val split + KMeans на эмбеддингах ---
    indices = np.arange(N)
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="./cifar100_data_semantic")
